...
namespace AsterionGame {
 public enum AbilityAimShape {None,Circle,Cone,Dash}
 ...
 public abstract class AbilityDefinition:ScriptableObject {
  ...
  [Min(0)] public float energyCost,energyOnHit,energyOnCast;
  ...
  public virtual float AimRadius=>0;
  public virtual float AimAngle=>0;
  public virtual float AimRange=>range;
  public virtual void OnStarted(AbilityContext context){}
