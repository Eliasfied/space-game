...
public sealed class AegisWallImportSettings : AssetPostprocessor {
 public const string Root="Assets/Art/MeshyEnvironment/CrimsonWall";
 public const string Revision="aegis-crimson-wall-1";
 ...
 static void OnPostprocessAllAssets(string[] imported,string[] deleted,string[] moved,string[] previous){
  foreach(string path in imported)
   if(path.StartsWith(Root+"/")&&(path.EndsWith(".fbx")||path.EndsWith(".png"))){AegisWallSetup.Queue();break;}
 }
}
